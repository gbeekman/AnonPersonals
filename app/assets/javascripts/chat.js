      ...
      */
      ...
      createChatBox: function (conversation_id, minimizeChatBox) {
        if ($("#chatbox_" + conversation_id).length > 0){
          ...
          $("chatbox_" + conversation_id + ".chatboxarea").focus();
          return;
        }
        ...
        $("#chatbox_" + conversation_id + " .chatboxarea").blur(function () {
          chatboxFocus[conversation_id] = false;
          $("#chatbox_" + conversation_id + " .chatboxarea").removeClass('chatboxareaselected');
        }).focus(function () {
          chatboxFocus[conversation_id] = true;
          $('#chatbox_' + conversation_id + ' .chatboxhead').removeClass('chatboxblink');
          $('#chatbox_' + conversation_id + " .chatboxarea").addClass('chatboxareaselected');
        });
